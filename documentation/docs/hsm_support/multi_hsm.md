...
| Field | Description |
|---|---|
| `hsm_model` | HSM model: `softhsm2`, `utimaco`, `proteccio`, `crypt2pay`, `smartcardhsm`, `aws_cloudhsm`, `kryoptic`, `other` |
...
- Linux x86\_64 — all models (`softhsm2`, `utimaco`, `proteccio`, `crypt2pay`, `smartcardhsm`, `aws_cloudhsm`, `kryoptic`, `other`)
- Linux arm64 — `softhsm2`, `smartcardhsm`, `aws_cloudhsm`, `other`
