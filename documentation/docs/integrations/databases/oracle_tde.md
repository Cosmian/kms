...
For Oracle Database OS, the PKCS#11 library is available here: [cosmian-pkcs11](https://package.cosmian.com/kms/5.19.0/deb/amd64/non-fips/static/cosmian-kms-cli-non-fips-static-openssl_5.19.0_amd64.deb).

- Extract the package:

    ```bash
    dpkg-deb -x cosmian-kms-cli-non-fips-static-openssl_5.19.0_amd64.deb extracted/
    ```
