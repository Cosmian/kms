...
See [Authenticating users to the KMS](../../configuration/authentication.md#tls-client-certificate-authentication) to learn how to configure the KMS to use Open ID Connect or certificate authentication.
