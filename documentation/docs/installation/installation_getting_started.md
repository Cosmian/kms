...
=== "Debian-based distributions"
    ...
    wget https://package.cosmian.com/kms/5.13.0/deb/x86_64/non-fips/static-openssl/cosmian-kms-server-non-fips-static-openssl_5.13.0_amd64.deb
    ...
    ```sh
    wget https://package.cosmian.com/kms/5.13.0/deb/x86_64/fips/static-openssl/cosmian-kms-server-fips-static-openssl_5.13.0_amd64.deb
...
=== "Rocky Linux distributions"
    ...
    wget https://package.cosmian.com/kms/5.13.0/rpm/x86_64/non-fips/static-openssl/cosmian-kms-server-non-fips-static-openssl_5.13.0_x86_64.rpm
...
Available dynamic packages for Debian-based distributions:
    ...
    wget https://package.cosmian.com/kms/5.13.0/deb/x86_64/non-fips/dynamic-openssl/cosmian-kms-server-non-fips-dynamic-openssl_5.13.0_amd64.deb
    # FIPS dynamic
    wget https://package.cosmian.com/kms/5.13.0/deb/x86_64/fips/dynamic-openssl/cosmian-kms-server-fips-dynamic-openssl_5.13.0_amd64.deb
    ```
...
Available dynamic packages for Rocky Linux:
    ...
    ```sh
    # Non-FIPS dynamic
    wget https://package.cosmian.com/kms/5.13.0/rpm/x86_64/non-fips/dynamic-openssl/cosmian-kms-server-non-fips-dynamic-openssl_5.13.0_x86_64.rpm
    # FIPS dynamic
    wget https://package.cosmian.com/kms/5.13.0/rpm/x86_64/fips/dynamic-openssl/cosmian-kms-server-fips-dynamic-openssl_5.13.0_x86_64.rpm
    ```
...
=== "Windows"
    ...
    ```sh
    https://package.cosmian.com/kms/5.13.0/windows/x86_64/non-fips/static-openssl/cosmian-kms-server-non-fips-static-openssl_5.13.0_amd64.exe
    ```
