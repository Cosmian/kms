...
```sh
# Debian package
gpg --verify cosmian-kms-server-non-fips-static-openssl_5.19.0_amd64.deb.asc \
             cosmian-kms-server-non-fips-static-openssl_5.19.0_amd64.deb

# RPM package
gpg --verify cosmian-kms-server-non-fips-static-openssl_5.19.0_x86_64.rpm.asc \
             cosmian-kms-server-non-fips-static-openssl_5.19.0_x86_64.rpm

# DMG package
gpg --verify cosmian-kms-server-non-fips-static-openssl-5.19.0_arm64.dmg.asc \
             cosmian-kms-server-non-fips-static-openssl-5.19.0_arm64.dmg
```
...
=== "Debian-based distributions"
    ...
    wget https://package.cosmian.com/kms/5.19.0/deb/amd64/non-fips/static/cosmian-kms-server-non-fips-static-openssl_5.19.0_amd64.deb
    sudo apt install ./cosmian-kms-server-non-fips-static-openssl_5.19.0_amd64.deb
    ...
    ```sh
    wget https://package.cosmian.com/kms/5.19.0/deb/amd64/fips/static/cosmian-kms-server-fips-static-openssl_5.19.0_amd64.deb
    sudo apt install ./cosmian-kms-server-fips-static-openssl_5.19.0_amd64.deb
    sudo cosmian_kms --version
    ```
...
=== "Rocky Linux distributions"
    ...
    wget https://package.cosmian.com/kms/5.19.0/rpm/amd64/non-fips/static/cosmian-kms-server-non-fips-static-openssl_5.19.0_x86_64.rpm
    sudo dnf install ./cosmian-kms-server-non-fips-static-openssl_5.19.0_x86_64.rpm
    sudo cosmian_kms --version
    ```
...
=== "Windows"
    ...
    ```sh
    https://package.cosmian.com/kms/5.19.0/windows/x86_64/non-fips/static-openssl/cosmian-kms-server-non-fips-static-openssl_5.19.0_x86_64.exe
    ```
