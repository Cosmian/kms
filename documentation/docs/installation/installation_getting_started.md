...
=== "Ubuntu 22.04"
    ...
    wget https://package.cosmian.com/kms/5.3.2/ubuntu-22.04/cosmian-kms-server_5.3.2-1_amd64.deb
    sudo apt install ./cosmian-kms-server_5.3.2-1_amd64.deb
    ...
    ```sh
    wget https://package.cosmian.com/kms/5.3.2/ubuntu-22.04/cosmian-kms-server-fips_5.3.2-1_amd64.deb
    sudo apt install ./cosmian-kms-server-fips_5.3.2-1_amd64.deb
    sudo cosmian_kms --version
    ```
...
=== "Ubuntu 24.04"
    ...
    ```sh
    sudo apt update && sudo apt install -y wget
    wget https://package.cosmian.com/kms/5.3.2/ubuntu-24.04/cosmian-kms-server_5.3.2-1_amd64.deb
    sudo apt install ./cosmian-kms-server_5.3.2-1_amd64.deb
    sudo cosmian_kms --version
    ```
    ...
    ```sh
    wget https://package.cosmian.com/kms/5.3.2/ubuntu-24.04/cosmian-kms-server-fips_5.3.2-1_amd64.deb
    sudo apt install ./cosmian-kms-server-fips_5.3.2-1_amd64.deb
    sudo cosmian_kms --version
    ```
...
=== "Rocky Linux 8"
    ...
    wget https://package.cosmian.com/kms/5.3.2/rockylinux8/cosmian_kms_server-5.3.2-1.x86_64.rpm
    sudo dnf install ./cosmian_kms_server-5.3.2-1.x86_64.rpm
    sudo cosmian_kms --version
    ```
...
=== "Rocky Linux 9"
    ...
    ```sh
    sudo dnf update && sudo dnf install -y wget
    wget https://package.cosmian.com/kms/5.3.2/rockylinux9/cosmian_kms_server-5.3.2-1.x86_64.rpm
    sudo dnf install ./cosmian_kms_server-5.3.2-1.x86_64.rpm
    sudo cosmian_kms --version
    ```
...
=== "MacOS"
    ...
    ```sh
    wget https://package.cosmian.com/kms/5.3.2/macos_arm-release.zip
    ...
    ```sh
    wget https://package.cosmian.com/kms/5.3.2/macos_intel-release.zip
...
=== "Windows"
    ...
    ```sh
     https://package.cosmian.com/kms/5.3.2/windows-release.zip
    ```
