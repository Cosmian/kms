...
| **Operating System** | Ubuntu 24.04 LTS (Noble) | x86_64 architecture |
| **OpenSSL** | 3.0+ | For TLS/mTLS communication |
...
```bash
# On KMS server
cd /path/to/cosmian/kms/target/debug
