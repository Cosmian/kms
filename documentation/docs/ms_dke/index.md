...
Using the [Cosmian CLI](../kms_clients/index.md), create a 2048-bit RSA key with the tag `dke_key`:
...
If later on you need to rotate the DKE key, you can use the [Cosmian CLI](../kms_clients/index.md) to create a new
key with a new tag.
