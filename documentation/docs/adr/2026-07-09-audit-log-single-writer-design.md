---
<<<<<<<< HEAD:documentation/docs/adr/2026-07-09-003-audit-log-single-writer-design.md
title: "ADR-0003: Tamper-Evident JSONL Audit Log — Single-Writer Architecture"
status: "Superseded"
========
title: "ADR-2026-07-09-audit-log-single-writer-design: Tamper-Evident JSONL Audit Log — Single-Writer Architecture"
status: "Accepted"
>>>>>>>> 53a6ac65f (test: add coverage for per-user metric labels and cardinality overflow):documentation/docs/adr/2026-07-09-audit-log-single-writer-design.md
date: "2026-07-09"
...
# ADR-2026-07-09-audit-log-single-writer-design: Tamper-Evident JSONL Audit Log — Single-Writer Architecture
...
- **REF-009**: ADR-2026-08-10-tcp-syslog-cef-transport — TCP Syslog CEF Transport (production CEF delivery)
