---
<<<<<<<< HEAD:documentation/docs/adr/2026-07-09-005-cef-siem-export-format.md
...
>>>>>>>> 53a6ac65f (test: add coverage for per-user metric labels and cardinality overflow):documentation/docs/adr/2026-07-09-cef-siem-export-format.md
status: "Accepted"
date: "2026-07-09"
