...
The Cosmian KMS is designed to [operate in **zero-trust** environments](#support-for-public-cloud-and-zero-trust-environments), such as the public cloud, using confidential VMs and a fully application-level encrypted database.
