...
!!! info "Quick start"
    ...
    ```sh
    docker run -p 9998:9998 --name kms ghcr.io/cosmian/kms:4.13.2
    ```
    ...
    Alternatively KMS binaries are also available on [Cosmian packages](https://package.cosmian.com/kms/4.13.2/).
...
the [Cosmian public packages repository](https://package.cosmian.com/kms/4.13.2/)
...
```sh
docker run --rm ghcr.io/cosmian/kms:4.13.2 --help
```
