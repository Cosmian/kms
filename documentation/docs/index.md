...
- [Debian](https://package.cosmian.com/kms/4.21.1/ubuntu-22.04/) or [RPM](https://package.cosmian.com/kms/4.21.1/rhel9/) package
...
- Pre-built [binaries](https://package.cosmian.com/kms/4.21.1/) for multiple operating systems (Linux, Windows, MacOS)
