...
!!! info "Quick start"
    ...
    Alternatively KMS binaries are also available on [Cosmian packages](https://package.cosmian.com/kms/4.13.3/).
...
the [Cosmian public packages repository](https://package.cosmian.com/kms/4.13.3/)
...
```sh
docker run --rm ghcr.io/cosmian/kms:4.13.3 --help
```
