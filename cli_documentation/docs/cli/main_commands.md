...
**`kem`** [[7]](#7-ckms-kem)  Manage Configurable KEM keys. Encrypt and decrypt data
...
**`key-gen`** [[7.1]](#71-ckms-kem-key-gen)  Create a new Configurable-KEM keypair and return the key IDs.

**`encrypt`** [[7.2]](#72-ckms-kem-encrypt)  Encapsulate a new symmetric key

**`decrypt`** [[7.3]](#73-ckms-kem-decrypt)  Open a Configurable-KEM encapsulation

---

## 7.1 ckms kem key-gen
