...
- Deterministic (Nix-first, recommended): use the unified script `.github/scripts/nix.sh` for a pinned toolchain,
  reproducible builds, and packaging.
- Simple (Cargo-only): quick local build without Nix.
