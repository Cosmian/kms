...
const SYM_KEY_ROUTES: Route[] = [
    ...
    { name: "re-key", path: "/ui/sym/keys/re-key" },
...
const RSA_KEY_ROUTES: Route[] = [
    ...
    { name: "re-key", path: "/ui/rsa/keys/re-key" },
...
const EC_KEY_ROUTES: Route[] = [
    ...
    { name: "re-key", path: "/ui/ec/keys/re-key" },
...
const PQC_KEY_ROUTES: Route[] = [
    ...
    { name: "re-key", path: "/ui/pqc/keys/re-key" },
...
const CC_KEY_ROUTES: Route[] = [
    ...
    { name: "re-key", path: "/ui/cc/keys/re-key" },
