...
const SYM_KEY_ROUTES: Route[] = [
    ...
    { name: "rekey", path: "/ui/sym/keys/rekey" },
    { name: "set-rotation-policy", path: "/ui/sym/keys/set-rotation-policy" },
    { name: "get-rotation-policy", path: "/ui/sym/keys/get-rotation-policy" },
