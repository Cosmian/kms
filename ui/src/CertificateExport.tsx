...
const CertificateExportForm: React.FC = () => {
    ...
    const onFinish = async (values: CertificateExportFormData) => {
        ...
        try {
            ...
            const request = export_certificate_ttlv_request(
                id,
                values.outputFormat,
                ...
                <Space direction="vertical" size="middle" style={{ display: 'flex' }}>
                    <Card>
                        ...
                        <Form.Item
                            name="tags"
                            label="Tags"
                            help="Alternative to Certificate ID: specify tags to identify the certificate"
                        >
                            <Select
                                mode="tags"
                    ...
                    <Card>
                        <Form.Item
                            ...
                            help="Allow exporting revoked and destroyed certificates or private keys (user must be the owner). Destroyed objects have their key material removed."
                        >
                            <Checkbox>Allow revoked certificates</Checkbox>
                        </Form.Item>
                    </Card>
                    <Form.Item>
                        <Button
