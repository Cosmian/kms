                ...
                <Space direction="vertical" size="middle" style={{ display: 'flex' }}>
                    <Card>
                        ...
                        >
                            <Select
                                ...
                                onChange={(value) => handleFormatChange(value as CertificateInputFormat)}
                            />
                        </Form.Item>
                    ...
                    {showRelationships && (
                        <Card>
                            ...
                            <Form.Item
                                ...
                                help="Link to corresponding private key in KMS"
                            >
                            ...
                            <Form.Item
                                name="publicKeyId"
                                label="Public Key ID"
                                help="Link to corresponding public key in KMS"
                            >
                            ...
                            <Form.Item
                                ...
                                help="Link to issuer certificate in KMS"
                            >
                    ...
                    <Card>
                        <Form.Item
                            name="keyUsage"
                            label="Key Usage"
                            help="Specify allowed operations for this certificate"
                        >
                            <Select
                                mode="multiple"
                        ...
                        <Form.Item
                            name="tags"
                            label="Tags"
                            help="Optional: Add tags to help retrieve the certificate later"
                        >
                            <Select
                                mode="tags"
                        ...
                        <Form.Item
                            ...
                            help="Replace an existing certificate with the same ID"
                        >
