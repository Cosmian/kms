      ...
      case 'key_usage':
        return (
          <Form.Item
            name="attribute_value"
            label="Key Usage"
            rules={[{ required: true, message: 'Please select key usage' }]}
          >
  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-8 space-y-2">
        <div>
          Set a single attribute for a KMIP object by specifying the object ID or tags.
        </div>
        <div className="text-sm text-yellow-600">
          When using tags to identify the object, rather than the object ID, an error is returned if multiple objects matching the tags are found.
        </div>
      </div>
        ...
        <Space direction="vertical" size="middle" style={{ display: 'flex' }}>
          <Card title="Object Identification">
            ...
            <Form.Item
              name="tags"
              label="Tags"
              help="Tags to use to retrieve the object when no object ID is specified"
            >
              <Select
                mode="tags"
                style={{ width: '100%' }}
          ...
          <Card title="Attribute Setting">
            <div className='mb-5'>
              Select one attribute to set for the selected KMIP object.
            </div>
