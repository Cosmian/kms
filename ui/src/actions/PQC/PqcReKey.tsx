...
const PqcReKeyForm: React.FC = () => {
    ...
    return (
        <div className="p-6">
            <h1 className="text-2xl font-bold mb-6">Re-Key a Post-Quantum key pair</h1>

            <div className="mb-8 space-y-2">
                <p>Rotate an existing post-quantum key pair (ML-KEM, ML-DSA), generating new key material.</p>
                <ul className="list-disc pl-5 space-y-1">
                    <li>A new private key and public key are created with the same algorithm.</li>
