...
const ECReKeyForm: React.FC = () => {
    ...
    return (
        <div className="p-6">
            <h1 className="text-2xl font-bold mb-6">Re-Key an Elliptic Curve key pair</h1>

            <div className="mb-8 space-y-2">
                <p>Rotate an existing EC key pair, generating new key material.</p>
                <ul className="list-disc pl-5 space-y-1">
                    <li>A new private key and public key are created with the same curve.</li>
