...
const MainLayout: React.FC = () => {
    ...
    return (
        <Layout>
            <Layout.Header className="fixed w-full z-10 p-0 h-16 border-b border-gray-300">
                <Header />
            </Layout.Header>
            <Layout id="main-page" className="overflow-hidden" style={{ marginTop: 64, height: 'calc(100vh - 64px)' }}>
                <Sidebar />
                <Layout id="main-center" className="flex flex-col overflow-hidden border-l border-gray-300">
