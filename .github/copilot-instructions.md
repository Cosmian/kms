...
> **Canonical file**: `AGENTS.md` at the repo root — `.github/copilot-instructions.md` and `CLAUDE.md` are symlinks to this file. It explains project structure, build commands, CI workflows, coding conventions, and troubleshooting steps.
