...
**299 vectors** across 8 categories:
...
| Integrations                                | `fips/integrations/fortigate_locate_many_similar_names` | Register ×8, Activate ×8, Locate ×8 (strict name match with MaximumItems=1), Revoke ×8, Destroy ×8 (binary TTLV / KMIP 1.0)                                                 | 40    |
| Integrations                                | `fips/integrations/fortigate_locate_multi_tunnel`       | Register ×6 (3 tunnels), Activate ×6, Locate ×6 (cross-tunnel isolation), Revoke ×6, Destroy ×6 (binary TTLV / KMIP 1.0)                                                    | 30    |
| Integrations                                | `fips/integrations/fortigate_locate_no_match`           | Register ×2, Activate ×2, Locate ×3 (substring/superstring/non-existent → 0 results), Revoke ×2, Destroy ×2 (binary TTLV / KMIP 1.0)                                        | 11    |
