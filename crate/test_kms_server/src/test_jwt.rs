...
///
/// This token is used in integration tests that exercise JWT authentication.
/// It is signed by the Auth0 tenant at `demo-kms.eu.auth0.com` using the
/// RS256 key identified by `kid = 7SmnRm_Mnc4aZ4mSPG_nU`.
///
/// In test builds the server uses `insecure_decode`, so the signature is not
/// verified; the token is still required to carry a valid `email` claim.
pub const AUTH0_TOKEN: &str = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IjdTbW5SbV9NbmM0YVo0bVNQR19uVSJ9..OssdvoPzOTiZ03pQN8eijHM-DRjVKj4vj7gt8_qqZIXhU-hvLB-7uJ8nRhKj8WSgyjMTLW__TkFTEVlqHL-vGRI3L-TIPrCAyKe37cBywqiLXIgYSKhijh23OFd7NizpeSiF_fjR3AGfRL80NCASwKVATexOI7WM8vI4rkZWh1Yrj9bIFRbtdK9YcdHz6fOrYp-K1hyIDnQ5fTaizpZhZuTTkGC1xBegn0JpZcyeUWsYPxh_9ICw0GRplYkA4ZX_QPcRReJqCVlK3dwuFvM545xz9IPlDaaa1APsa-KMQZBoVbdg9mwxg_sxkO235aC7qvX1v4fOhxjNIkFgBcm6EA";
