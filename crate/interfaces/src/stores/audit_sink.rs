...
pub trait AuditSink: Send {
    ...
    /// `true` the event is silently skipped without ever calling [`Self::write_event`],
    ...
    /// and reports it here instead of returning an error from `write_event` — an error
