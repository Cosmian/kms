...
A single KMS instance can manage several groups, that is to say, severals databases.
...
To response to the user queries, the KMS is expecting the user to send the key with the query. 
