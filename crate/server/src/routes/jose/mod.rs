...
pub(crate) use tags::{
    add_tags as add_tags_handler, list_tags as list_tags_handler,
    remove_tags as remove_tags_handler,
};
...
pub(crate) const fn ecdsa_coord_size(alg: JoseAlgorithm) -> Option<usize> {
    match alg {
        JoseAlgorithm::ES256 => Some(32),
        JoseAlgorithm::ES384 => Some(48),
        JoseAlgorithm::ES512 => Some(66),
        _ => None,
    }
}
