...
impl From<KmsError> for CryptoApiError {
    fn from(e: KmsError) -> Self {
        match e {
            ...
            KmsError::CryptographicError(msg) => Self::CryptoFailure(msg),
            KmsError::Kmip21Error(_, msg) => Self::CryptoFailure(msg),
            KmsError::Kmip14Error(_, msg) => Self::CryptoFailure(msg),
            KmsError::NotSupported(msg) => Self::CryptoFailure(msg),
    ...
    base64::engine::general_purpose::URL_SAFE_NO_PAD
        ...
        .map_err(|e| {
            CryptoApiError::BadRequest(format!(
                "Field '{field}' is not valid base64url: {e}"
            ))
        })
}
