...
use super::{
    ...
    KmipPolicyConfig, MainDBConfig, OpaConfig, RolesConfig, WorkspaceConfig,
...
pub struct ClapConfig {
    ...
    #[clap(long, default_value = "7", value_parser = clap::value_parser!(u32).range(1..=365), verbatim_doc_comment)]
