...
use cosmian_crypto_base::{entropy::CsRng, symmetric_crypto::ff1::KEY_LENGTH};
use cosmian_kmip::{
    error::KmipError,
    kmip::{
...
/// Generate a symmetric key for FPE usage: a 256 bits key
/// `cryptographic_length` is a value in bytes
pub fn create_fpe_ff1_symmetric_key(
