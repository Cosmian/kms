...
use cosmian_pkcs11_module::{
    pkcs11::{
        ...
        C_Initialize, C_Login, C_LoginUser, C_OpenSession, SLOT_ID,
    },
    test_decrypt, test_encrypt,
    traits::{Backend, SignatureAlgorithm},
};
use pkcs11_sys::{
    CK_ATTRIBUTE, CK_FUNCTION_LIST, CK_INVALID_HANDLE, CK_OBJECT_CLASS, CK_ULONG, CK_USER_TYPE,
    CKA_CLASS, CKA_LABEL, CKF_SERIAL_SESSION, CKO_DATA, CKR_ARGUMENTS_BAD, CKR_OK,
    CKR_OPERATION_NOT_INITIALIZED, CKR_USER_TYPE_INVALID, CKU_CONTEXT_SPECIFIC, CKU_SO, CKU_USER,
};
