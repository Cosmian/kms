...
fn list_identities(
    cli_conf_path: &str,
    user_id: &str,
) -> Result<ListIdentitiesResponse, CosmianError> {
    // List identities
...
fn get_identities(cli_conf_path: &str, user_id: &str) -> Result<Identity, CosmianError> {
    // Get identities
...
fn delete_identities(cli_conf_path: &str, user_id: &str) -> Result<(), CosmianError> {
    // Delete identities
