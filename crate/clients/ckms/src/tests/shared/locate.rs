...
pub(crate) async fn test_locate_cover_crypt() -> CosmianResult<()> {
    ...
    let ids = locate(
        &owner_client_conf_path,
        Some(&["test_cc", SYSTEM_TAG_COVER_CRYPT_USER_KEY]),
        None,
        None,
        None,
    )?;
    ...
    let ids = locate(
        &owner_client_conf_path,
        Some(&["test_cc", SYSTEM_TAG_PRIVATE_KEY]),
        None,
        None,
        None,
    )?;
    ...
    let ids = locate(
        &owner_client_conf_path,
        Some(&["test_cc", SYSTEM_TAG_PUBLIC_KEY]),
        None,
        None,
        None,
    )?;
...
pub(crate) async fn test_locate_elliptic_curve() -> CosmianResult<()> {
    ...
    let ids = locate(
        &owner_client_conf_path,
        Some(&["test_ec", SYSTEM_TAG_PRIVATE_KEY]),
        None,
        None,
        None,
    )?;
    ...
    let ids = locate(
        &owner_client_conf_path,
        Some(&["test_ec", SYSTEM_TAG_PUBLIC_KEY]),
        None,
        None,
        None,
    )?;
...
pub(crate) async fn test_locate_symmetric_key() -> CosmianResult<()> {
    ...
    let ids = locate(
        &owner_client_conf_path,
        Some(&["test_sym", SYSTEM_TAG_SYMMETRIC_KEY]),
        None,
        None,
        None,
    )?;
