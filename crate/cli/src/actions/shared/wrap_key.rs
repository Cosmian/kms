...
pub struct WrapKeyAction {
    ...
    /// This password will be derived into a AES-256 symmetric key. For security reasons, a fresh salt is internally handled abd generated by `ckms` and this final AES symmetric key will be displayed only once.
