...
pub struct WrapSecretDataOrKeyAction {
    ...
    /// This password will be derived into an AES-256 symmetric key. For security reasons, a fresh salt is internally handled and generated by `cosmian`, and this final AES symmetric key will be displayed only once.
