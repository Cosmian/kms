...
use crate::{
    actions::{console, kms::shared::SYMMETRIC_WRAPPING_KEY_SIZE},
    cli_bail,
...
pub struct WrapKeyAction {
    ...
    /// This password will be derived into a AES-256 symmetric key. For security reasons, a fresh salt is internally handled and generated by `cosmian` and this final AES symmetric key will be displayed only once.
