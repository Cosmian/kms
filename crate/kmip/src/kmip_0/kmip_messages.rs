...
//     pub operation: OperationEnumerationVersioned,
//
...
//     pub request_payload: OperationVersioned,
//
...
//     #[must_use]
//     pub const fn new(request: OperationVersioned) -> Self {
//         Self {
...
//     V21,
// }
// struct RequestMessageBatchItemDeserializer {
//     major_version: KmipVersion,
// }
//
// impl<'de> DeserializeSeed<'de> for RequestMessageBatchItemDeserializer {
...
//             KmipVersion::V14 => RequestMessageBatchItem::deserialize(deserializer),
//             KmipVersion::V21 => RequestMessageBatchItem::deserialize(deserializer),
//         }
//     }
// }
//
...
//                 V: MapAccess<'de>,
//             {
//                 let mut operation: Option<OperationEnumerationVersioned> = None;
//                 let mut ephemeral: Option<bool> = None;
//                 let mut unique_batch_item_id: Option<String> = None;
//                 let mut request_payload: Option<OperationVersioned> = None;
...
//     pub operation: Option<OperationEnumerationVersioned>,
//
//     /// Required if present in request Batch Item
//     pub unique_batch_item_id: Option<String>,
//
...
//     pub response_payload: Option<OperationVersioned>,
//
