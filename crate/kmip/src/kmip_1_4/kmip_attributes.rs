...
use crate::{
    ...
    kmip_1_4::{
        ...
        kmip_types::{
            CryptographicAlgorithm, CryptographicDomainParameters, CustomAttribute, Digest,
                ...
                match attribute_name_value.as_str() {
                    ...
                    name => {
                        if name.starts_with("x-") || name.starts_with("y-") {
                            return Ok(Attribute::CustomAttribute(CustomAttribute {
                                name: name.to_owned(),
                                value: CustomAttributeValue::TextString(map.next_value()?),
                            }));
                        }
