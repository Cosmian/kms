...
use crate::{
    ...
    kms_crypto_bail, DecryptionSystem, EncryptionSystem,
};

/// Encrypt bytes using the wrapping key
pub fn encrypt_bytes(wrapping_key: &Object, plaintext: &[u8]) -> Result<Vec<u8>, KmsCryptoError> {
    debug!(
    ...
    match wrapping_key {
        Object::Certificate {
            ...
            let ciphertext = encrypt_response.data.ok_or(KmsCryptoError::Default(
        ...
        _ => Err(KmsCryptoError::NotSupported(format!(
...
fn decrypt_with_private_key(
    ...
    let plaintext = Zeroizing::from(decrypt_response.data.ok_or(KmsCryptoError::Default(
...
mod tests {
    ...
    use crate::elliptic_curves::operation::create_x25519_key_pair;
    use crate::symmetric::create_symmetric_key_kmip_object;
