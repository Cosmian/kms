...
use crate::{error::KmsCryptoError, wrap::wrap_key_bytes};
...
pub fn build_locate_symmetric_key_request(access_policy: &str) -> Result<Locate, KmsCryptoError> {
    Ok(Locate {
...
pub fn build_destroy_key_request(unique_identifier: &str) -> Result<Destroy, KmsCryptoError> {
    Ok(Destroy {
...
) -> Result<ReKeyKeyPair, KmsCryptoError> {
    Ok(ReKeyKeyPair {
