...
use crate::{error::KmsCryptoError, DecryptionSystem};
...
impl CovercryptDecryption {
    ...
    fn decrypt(
    ...
    ) -> Result<(CleartextHeader, Vec<u8>), KmsCryptoError> {
        ...
        let header = encrypted_header
            ...
            .map_err(|e| KmsCryptoError::Kmip(ErrorReason::Invalid_Message, e.to_string()))?;
