...
The Nix derivation in `nix/openssl.nix` will automatically use the local tarball if present (for the 3.1.2 FIPS provider build), otherwise it will fall back to downloading from the internet.
